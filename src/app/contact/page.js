        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
          ...
          <div className="p-4 py-6 rounded-lg bg-gray-50  md:p-8">
            <form>
              ...
              <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[--darktext] rounded-lg hover:bg-[--medtext] focus:outline-none focus:ring focus:ring-[--medtext] focus:ring-opacity-50">
                Send message
              </button>
            </form>
          </div>
