...
export default function ViewCard() {
  return (
    <div
      className="w-full h-[70vh] bg-center bg-no-repeat justify-center flex text-xl md:text-2xl lg:text-4xl bg-cover items-center relative"
      style={{
        backgroundImage:
    ...
    >
      ...
      {/* FOOTER DIVIDER */}
      <div className="custom-shape-divider-bottom-1739479905">
        <svg
          data-name="Layer 1"
