...
export default function Slider() {
  ...
  return (
    <div>
      <div className="flex flex-row w-full justify-center absolute">
        {/* HEADER DIVIDER */}
        <div className="custom-shape-divider-top-1739570364">
          <svg
            data-name="Layer 1"
        ...
        <div className="mt-50">
          ...
          <ChevronsLeft
            className="hidden md:block md:left-0 md:top-3/4 cursor-pointer hover:bg-neutral-200 absolute "
            width={50}
            height={50}
            style={{
              color: "grey",
          ...
          />
          <ChevronsRight
            className="hidden md:block md:right-0 md:top-3/4 hover:bg-neutral-200 absolute "
            width={50}
            height={50}
